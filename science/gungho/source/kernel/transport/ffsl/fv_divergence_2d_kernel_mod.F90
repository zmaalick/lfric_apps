...
!-----------------------------------------------------------------------------
!
!> @brief Computes the finite-volume divergence in the 2d horizontal directions.
...
module fv_divergence_2d_kernel_mod
  ...
  !> Psy layer.
  !>
  type, public, extends(kernel_type) :: fv_divergence_2d_kernel_type
    private
