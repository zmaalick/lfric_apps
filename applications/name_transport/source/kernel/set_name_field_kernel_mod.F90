...
!>
module set_name_field_kernel_mod
  ...
  !> Psy layer.
  !>
  type, public, extends(kernel_type) :: set_name_field_kernel_type
    private
    type(arg_type) :: meta_args(4) = (/                                         &
         arg_type(GH_FIELD,   GH_REAL,    GH_WRITE, ANY_DISCONTINUOUS_SPACE_1), & ! tracer
         arg_type(GH_FIELD*3, GH_REAL,    GH_READ,  Wchi),                      & ! chi
  ...
  contains
    procedure, nopass :: set_name_field_code
  end type

  !---------------------------------------------------------------------------
  ! Contained functions/subroutines
  !---------------------------------------------------------------------------
  public :: set_name_field_code
...
subroutine set_name_field_code(nlayers, tracer,                        &
                               chi_1, chi_2, chi_3,                    &
                               panel_id,                               &
                               domain_max_x,                           &
...
end subroutine set_name_field_code

end module set_name_field_kernel_mod
